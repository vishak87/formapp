...
class _HomePageState extends State<HomePageForm> {
          ...
          child: TextFormField(
            ...
            validator: (String value) {
              if (value.isEmpty ||
                  ...
                  double.parse(value) > 99) {
                return 'Should be a number and less than 100';
              }
            },
            onSaved: (String value) {
          ...
          child: TextFormField(
            ...
            validator: (String value) {
              if (value.isEmpty ||
                ...
                return 'Should be a number and less than 3';
              }
            },
            onSaved: (String value) {
    ...
    return TextFormField(
      ...
      validator: (String value) {
        if (value.isEmpty ||
          ...
          return 'Should be a number less than 3';
        }
      },
      onSaved: (String value) {
      ...
      children: <Widget>[
        Flexible(
          child: TextFormField(
            ...
            keyboardType: TextInputType.numberWithOptions(decimal: true),
            validator: (String value) {
              if (!validateNumber(value) || double.parse(value) > 99) {
                return 'Should be a number less than 100';
              }
            },
            onSaved: (String value) {
              _formdata[workerKey] = value;
          ...
          child: TextFormField(
            ...
            validator: (String value) {
              if (!validateNumber(value) || double.parse(value) > 3) {
                return 'Should be a number and less than 4';
              }
            },
            onSaved: (String value) {
              _formdata[shiftKey] = value;
      ...
      children: <Widget>[
        Flexible(
          child: TextFormField(
            ...
            validator: (String value) {
              if (!validateNumber(value) || double.parse(value) > 99) {
                return 'Should be a number and less than 150';
              }
            },
            onSaved: (String value) {
              _formdata[workerKey] = value;
          ...
          child: TextFormField(
            ...
            validator: (String value) {
              if (!validateNumber(value) || double.parse(value) > 150) {
                return 'Should be a number less than 150';
              }
            },
            onSaved: (String value) {
  ...
  calculatePendingSalary() {
    ...
    double labourSalary = (double.parse(_formdata['labourRow1']) *
        ...
        print('ot 1: '+ (double.parse(_formdata['workerOTRow1'])* double.parse(_formdata['shiftOTRow1'])).toString());
        print('ot 2: '+ (double.parse(_formdata['workerOTRow2'])* double.parse(_formdata['shiftOTRow2'])).toString());
        print('ot 3: '+ (double.parse(_formdata['workerOTRow3'])* double.parse(_formdata['shiftOTRow3'])).toString());
        print('otallowance :'+ otAllowance);
        otamount=((double.parse(_formdata['workerOTRow1'])* double.parse(_formdata['shiftOTRow1']))+
        (double.parse(_formdata['workerOTRow2'])* double.parse(_formdata['shiftOTRow2']))+
        (double.parse(_formdata['workerOTRow3'])* double.parse(_formdata['shiftOTRow3'])))*double.parse(otAllowance);

         double mesthriExtra = double.parse(_formdata['mesthriShift']) * double.parse(mesthriSalary);


         spray=double.parse(_formdata['sprayLabour']) * double.parse(sprayAllowance);

   double pendingSalary = labourSalary+double.parse(_formdata['otherAllowance'])+foodAllowance+spray+otamount+mesthriExtra
                  ...
                  if(response.statusCode==200){
                    ...
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            title: Text('Status'),
                            content: Text('Submission Failed'+response.statusCode.toString()),
                            actions: <Widget>[
                              FlatButton(
                                onPressed: () {
                                  Navigator.of(context).pop();
